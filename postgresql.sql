...
CREATE TABLE ticketr.tbl_ticket
(
...
CREATE TABLE ticketr.tbl_ticket_comment
(
  id character varying(30) NOT NULL,
...
CREATE TABLE ticketr.tbl_user_project
(
  iduser character varying(30),
  company character varying(50),
...
CREATE TABLE ticketr.cdl_project
(
   name character varying(30),
   primary key(name)
)
...
CREATE TABLE ticketr.cdl_label
(
   name character varying(30),
   primary key(name)
)
...
CREATE TABLE ticketr.cdl_language
(
   name character varying(30),
   primary key(name)
)
...
CREATE OR REPLACE VIEW ticketr.view_ticket AS
 SELECT a.id,
    a.name,
    a.project,
    a.search,
...
CREATE OR REPLACE VIEW ticketr.view_ticket_comment AS
 SELECT a.id,
    a.iduser,
    a.idparent,
    a.idticket,
...
CREATE OR REPLACE VIEW ticketr.view_user AS
 SELECT a.id,
    a.name,
    a.photo,
    a.email,
